	...
	<section>
		...
		<div class="vcc-banner-container">
			<div class="vcc-banner-img">
				<img :src="sponsor.lecture_background ? sponsor.lecture_background : '/assets/images/vcc/ROOM_7.jpg'" alt="">
		...
		<div class="vcc-switch-btn">
			<NuxtLink to="/virtual-convention-center/lobby/industry-lectures/gold">
				Back to<br><span>Gold Lectures Hall</span>
			</NuxtLink>
		</div>
	</section>
</template>
...
export default {
	...
	methods: {
		getLecture() {
            ...
            .catch(err => {
                console.error(err)
				this.$router.push('/virtual-convention-center/lobby/industry-lectures/gold')
            })
        },
	},
	async fetch() {
