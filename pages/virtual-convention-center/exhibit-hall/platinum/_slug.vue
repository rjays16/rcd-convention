	...
	<section>
		...
		<div class="vcc-banner-container" v-loading="loading">
			...
			<div class="vcc-banner-img">
                <img :src="sponsor.booth_design && sponsor.booth_design.photo ? sponsor.booth_design.photo : '/assets/images/vcc/BAYER.jpg'" alt="">
    ...
    methods: {
        getSponsorBySlug(slug, is_ready_for_new_stamp_round = false) {
            this.$store.dispatch("sponsors/getSponsorBySlug", slug)
                ...
                let type_data = data.sponsor.type;
                ...
                // this.sponsor.type.type_id = this.type_data.id
                ...
                // this.sponsor.type.type_id = type_data.id
                this.loading = false;
                this.stampTimer();
                this.logMemberVisit();
                this.getMessages();
        ...
        onExit() {
            if (this.stampMinuteIsZero !== true || this.sponsor.user_has_stamped_for_current_round === false) {
                this.$confirm("You haven't got your stamp. Do you still want to leave?", {
                    ...
                    this.$router.push("/virtual-convention-center/exhibit-hall/platinum");
                });
            }
            else {
                sessionStorage.removeItem("reload", false);
