	...
	<section>
		...
		<div class="vcc-banner-container" v-loading="loading">
			...
			<div class="vcc-banner-img">
                <img :src="sponsor.booth_design && sponsor.booth_design.photo ? sponsor.booth_design.photo : '/assets/images/vcc/LSSKINLAB.jpg'" alt="">
        ...
        onExit(){
            if(this.stampMinuteIsZero !== true || this.sponsor.user_has_stamped_for_current_round === false){
                ...
                .then(() => {
                    ...
                    this.$router.push('/virtual-convention-center/exhibit-hall/bronze')
                })
            }else{
                sessionStorage.removeItem('reload', false);
                this.logoutDelegateAttendance()
...
@media screen and (max-width: 915px) {
    .chat-container {
        button {
            background: url("/assets/images/vcc/vcc-chat-icon.png") no-repeat 6px 0px #EDC85A;
