	...
	<section>
		...
		<div class="vcc-banner-container" v-loading="loading">
			...
			<div class="vcc-banner-img">
                <img :src="sponsor.booth_design && sponsor.booth_design.photo ? sponsor.booth_design.photo : '/assets/images/vcc/DMARK.jpg'" alt="">
            ...
            <div class="vcc-switch-btn d-none">
                <a href="#" @click="add_visit_360_view">Switch to<br><span>360&#176; Tour View</span></a>
            </div>
            <div class="vcc-switch-btn-360 d-none" style="display: none;">
        ...
        <div class="container booth-content">
            <div class="row">
                ...
                <div class="col-md-6">
                    <VCCModalSponsorResources :sposor="sponsor" :brochures="brochures" :videos="videos" :product_catalog="product_catalog" :interactive_profile="interactive_profile" ref="assetsModal" />
                    <div class="contacts">
        ...
        onExit(){
            if(this.stampMinuteIsZero !== true || this.sponsor.user_has_stamped_for_current_round === false){
                ...
                .then(() => {
                    ...
                    this.$router.push('/virtual-convention-center/exhibit-hall/silver')
                })
            }else{
                sessionStorage.removeItem('reload', false);
                this.logoutDelegateAttendance()
