<template>
    <section id="international-resident-registration">
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <form class="opensans bs-1 color-636568 py-4 px-5 corner-20px" autocomplete="off">
                        ...
                        <div class="row mt-4 mb-2">
                            <div class="col-lg-4 col-md-12 demo-block demo-en-US demo-upload">
                                <el-upload
                                    ...
                                    <img v-if="img_url || form.resident_certificate" :src="img_url || form.resident_certificate" class="avatar" />
                                    <i v-else class="el-icon-picture-outline"></i>
                                </el-upload>
                            </div>
                            <div class="col-lg-8 col-md-12 opensans d-table">
...
export default {
    props: ['countries', 'specific_countries', 'GET_TYPE'],
    computed: {
        ...mapState({
    ...
    methods: {
        ...
        register() {
            ...
            form.set('is_interested_for_ws', this.form.is_interested_for_ws == true ? 1 : 0)
            form.set('ws_to_attend', this.form.is_interested_for_ws == true ? this.form.ws_to_attend : 0)
            form.set('role', this.form.role )

			disableButton('.btn-submit', true)
			this.$store.dispatch(this.registration_string, form)
            .then(res => {
