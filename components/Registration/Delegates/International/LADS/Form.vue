<template>
    <section id="international-lads-registration">
        ...
        <div class="container my-5">
            <div class="row text-center">
                <div class="inline-block avenir-medium">
                    <button class="btn btn-blue py-2 px-5 corner-22px fs-5 me-3" @click="$parent.goToStep(5)">
                        Back
                    </button>
...
export default {
	...
	data() {
		return {
            ...
            image_types: ["image/png", "image/jpg", "image/jpeg", "image/heic"],
            file_max: 10000000,
            img_url: null,
    ...
    methods: {
        ...
        removeCountry: function (item){
            item.countries.splice(this.countries.indexOf(item.country), 1)
        },
