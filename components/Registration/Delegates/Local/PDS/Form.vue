<template>
    <section id="local-pds-delegates-registration">
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <form class="opensans bs-1 color-636568 py-4 px-5 corner-20px" autocomplete="off">
                        <div class="form-group row">
                            <div class="col-md-5 col-sm-9 mb-3">
                        ...
                        <div class="col-12 mb-3" v-show="form.type===6 ? true : false">
                            <el-select v-model="$v.form.training_institution.$model" class="w-100" placeholder="Accredited Institution" autocomplete="off">
                            <el-option
                                v-for="option in trainingInstitutions"
                                :key="option.id"
                                :value="option.id"
                                :label="option.name"
                            />
                            </el-select>
                            <div v-if="$v.form.training_institution.$dirty">
                                <div class="note-small color-FF2C2C" v-if="!$v.form.training_institution.required">Required</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12">
        ...
        <div class="container my-5">
            <div class="row text-center">
                <div class="inline-block avenir-medium">
                    <button class="btn btn-blue py-2 px-5 corner-22px fs-5 me-3" @click="$parent.goToStep(10)">
                        Back
                    </button>
...
export default {
	...
	data() {
		return {
            ...
            trainingInstitutions: this.$store.state.options.trainingInstitutions,
    ...
    methods: {
        ...
        register() {
            ...
            this.$store.dispatch("registration/registerDelegateExisting", this.form)
            .then(res => {
...
#local-pds-delegates-registration {
    line-height: 18px;
    font-size: 13px;
    .header {
