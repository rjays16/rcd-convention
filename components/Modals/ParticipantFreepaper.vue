<template>
  <section>
    <!-- Modal -->
    <div class="modal fade" id="participant_freepaper" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="modal-body">
            <div v-for="list in participants" :key="list.id" class="text-uppercase">
              <div v-if="list.abstract_category === select_category">
                <div v-for="(author, index) in list.authors" :key="index" class="inter-regular">
