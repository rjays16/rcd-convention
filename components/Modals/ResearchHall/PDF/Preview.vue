      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-body">
                <span>
                  <iframe sandbox="allow-scripts allow-same-origin" :src="this.form.url" height="97.5%" width="97.5%" frameborder="0" allowfullscreen></iframe>
                </span>
  ...
  methods: {
    ...
    openModal(id, is_preview) {
      ...
      this.$store.dispatch("abstracts/getAbstract", id)
        .then(res => {
          var data = res.data;
          this.preview_pdf(data, data.authors)
          setTimeout(() => {
            $('#pdf').modal('show');
          }, 3000);
        })
